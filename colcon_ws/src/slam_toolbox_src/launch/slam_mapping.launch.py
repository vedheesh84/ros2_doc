...
This launch file starts the SLAM Toolbox in online async mapping mode
along with the robot state publisher and RViz for visualization.
"""
...
def generate_launch_description():
    ...
    # SLAM Toolbox mapping launch file path
